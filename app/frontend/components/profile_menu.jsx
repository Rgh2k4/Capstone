...
export default function ProfileMenu( { onRouteToLogin, user } ) {
    ...
    <details className="relative">
        <summary className="cursor-pointer list-none [&::-webkit-details-marker]:hidden">
              ...
              <ul className="absolute right-0 z-50 mt-2 w-44 rounded-md bg-white p-1 shadow ring-1 ring-black/5">
                ...
                <li onClick={onRouteToLogin} className="block rounded px-3 py-2 text-red-600 hover:bg-red-50">Logout</li>   
              </ul>
        </summary>
